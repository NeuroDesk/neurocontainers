...
neurodocker generate ${neurodocker_buildMode} \
   ...
   --run='git clone https://github.com/felenitaribeiro/deepRetinotopy_TheToolbox.git && \
       ...
       git checkout 17b0699ef7e23810115355a91fc5e50439d6d6fd' \
   ...
   --env PATH=/opt/workbench/workbench/bin_rh_linux64/:/opt/deepRetinotopy_TheToolbox/:/opt/deepRetinotopy_TheToolbox/main/:'$PATH' \
   --env DEPLOY_BINS="wb_view:wb_command:wb_shortcuts:python:deepRetinotopy:signMaps:1_native2fsaverage.sh:2_inference.py:3_fsaverage2native.sh:4_signmaps.py" \
