...
neurodocker generate ${neurodocker_buildMode} \
   ...
   --miniconda version=py37_4.8.3 \
         ...
         pip_install='packaging pip==23.3.2 pandas==1.1.5 seaborn==0.11.1 nibabel==3.2.1 torch-geometric==1.6.3 scikit-learn==0.22.2 scipy==1.5.4 matplotlib==3.3.4 osfclient==0.0.5' \
