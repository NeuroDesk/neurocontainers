...
export toolName='diffusiontoolkit'
...
neurodocker generate ${neurodocker_buildMode} \
   ...
   --run="curl -fsSL --retry 5 https://object-store.rc.nectar.org.au/v1/AUTH_dead991e1fa847e3afcca2d3a7041f5d/neurodesk/Diffusion_Toolkit_v${toolVersion}_x86_64.tar.gz \
