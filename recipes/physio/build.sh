...
neurodocker generate ${neurodocker_buildMode} \
   ...
   --run="curl -fsSL --retry 5 https://object-store.rc.nectar.org.au/v1/AUTH_dead991e1fa847e3afcca2d3a7041f5d/neurodesk/spm12r8224_physioR2021a_standalone_MCRv99_MatlabR2020b_Linux.tar.gz \
